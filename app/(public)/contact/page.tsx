...
export const metadata: Metadata = {
  ...
  description:
    'Get in touch with Carlson Gracie Escondido. Book your free trial week, ask questions, or visit our academy in Escondido. Call, email, or fill out our contact form.',
  keywords: [
    'contact BJJ gym',
    'free trial BJJ',
